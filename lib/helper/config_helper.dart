 ...
 * @LastEditTime: 2021-06-30 15:17:43
 * @Description: 
 */
import 'dart:convert';
import 'dart:io';
import 'package:flutter_hot_fix_csx/base/enum.dart';
import 'package:flutter_hot_fix_csx/model/config_model.dart';
import 'package:flutter_hot_fix_csx/model/manifest_net_model.dart';
import 'package:flutter_hot_fix_csx/model/resource_model.dart';
import 'package:flutter_hot_fix_csx/operation/download_op.dart';
...
class ConfigHelp {
  ...
  static ConfigHelp _getInstance() {
    return _instance ??= new ConfigHelp._internal();
  }
